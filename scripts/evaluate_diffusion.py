...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_path', type=str, default='/media/aita4090/zyx/PMODiff/experiments_SA_1_50wan/sa1')
    ...
    parser.add_argument('--docking_mode', type=str, choices=['qvina', 'vina_score', 'vina_dock', 'none'],default='vina_score')
    parser.add_argument('--exhaustiveness', type=int, default=64)
    args = parser.parse_args()

    result_path = os.path.join(args.sample_path, 'eval_results_100_Vinascore')
